...
class FFFingerPrinter {
  ...
  _getStreamPropsString(stream) {
    if (stream.codec_type === 'audio') {
      ...
      return FFFingerPrinter.deterministicToStringObj({
        ...
        codec_time_base: s.codec_time_base || null,
      ...
      return FFFingerPrinter.deterministicToStringObj({
        ...
        pix_fmt: s.pix_fmt,
        sample_aspect_ratio: s.sample_aspect_ratio || null,
        display_aspect_ratio: s.display_aspect_ratio || null,
  ...
  static deterministicToStringObj(obj) {
    if (obj === void 0) {
      ...
      return obj.toString();
    } else if (Resolve.isTypeOf(obj, {}) || Object.getPrototypeOf(obj) === null) {
